...
public class cadastro {
    ...
    public static void cadastroUsuario(ArrayList<Usuarios> listaUsuarios) {
        ...
        // perguntas para cadastramento do usuario
        int parar = 0;
        ...
        do {
            ...
            int relacao = JOptionPane.showOptionDialog(null,
                    ...
                    opcoes,
                    opcoes[0]);
            // verificação se a janela foi fechada
            if (relacao == 3 || relacao == JOptionPane.CLOSED_OPTION) {
                ...
                // perguntas detalhadas de cada tipo de usuario
                switch (relacao) {
                    case 0:
                        ...
                        do {
                            ...
                            if (alunoTemp.validaEmail(matricula, email)) {
                                // adiciona o usuario a lista de usuaios
